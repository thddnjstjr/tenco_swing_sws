		...
		this.addKeyListener(new KeyAdapter() {
			...
			public void keyPressed(KeyEvent e) {
				...
				case KeyEvent.VK_SPACE:
					...
					System.out.println(player.getPlayerL());
					System.out.println(player.getPlayerR());
...
//					if (player.getIcon().equals("images/playerL.png")) {
//						System.out.println("1111111111");
//						bubble.leftfire();
//					} else if (player.getIcon().equals("images/playerR.png")) {
